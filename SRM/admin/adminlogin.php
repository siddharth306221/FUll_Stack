...
body  
{  
background-image:url("https://getmyuni.azureedge.net/college-image/big/srm-university-amaravati.jpg"); 
  ...
  <body>
    <div class="center">
      ...
      <form action="adminlogin.php" method="post">
        <div class="txt_field">
          <input id="employeeid" name="employeeid" type="text" pattern="AP[0-9]{11}" required>
          <span></span>
