...
body  
{  
background-image:url("https://www.shapoorjipallonji.com/assets/Desktop/Projects/640x640/srm-university-phase1-640x640.jpg"); 
  ...
  <body>
    <div class="center">
      ...
      <form method="post" action="signin.php" >
        <div class="txt_field">
          <input name="username" type="text" pattern="AP[0-9]{11}" required>
          <span></span>
          <label>Regno</label>
        </div>
        <div class="txt_field">
